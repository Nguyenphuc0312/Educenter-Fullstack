...
export const paymentApi = {
  ...
  createStudentRequest: (data) => callApi(http.post('/gateway/payments/student-request', data)),
  createMockGateway: (data) => callApi(http.post('/gateway/payments/mock-gateway', data)),
  bulkCreate: (items) => callApi(http.post('/gateway/payments/bulk-create', items)),
  confirm: (id) => callApi(http.put(`/gateway/payments/${id}/confirm`)),
