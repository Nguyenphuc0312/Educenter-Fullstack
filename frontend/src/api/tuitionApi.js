...
export const tuitionApi = {
  ...
  sendReminder: (id) => callApi(http.post(`/gateway/tuition/${id}/send-reminder`)),
  bulkSendReminder: (ids) => callApi(http.post('/gateway/tuition/bulk-send-reminder', { ids })),
  sendUpcomingReminders: (daysAhead = 3) => callApi(http.post('/gateway/tuition/send-upcoming-reminders', null, { params: { daysAhead } })),
