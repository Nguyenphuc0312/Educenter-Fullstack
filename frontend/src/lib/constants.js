...
export const PAYMENT_METHOD = { 2: 'Chuyển khoản', 3: 'Momo', 4: 'VNPay' }
export const PAYMENT_STATUS = { 1: 'Thành công', 2: 'Chờ xác nhận', 3: 'Thất bại', 4: 'Đã hủy' }
export const LEARNING_MODE = { 0: 'Offline', 1: 'Online', 2: 'Hybrid' }
