...
const routes = [
  // Public
  {
    ...
    children: [
      ...
      { path: 'courses/:slug', name: 'course-detail', component: CourseDetailPage, props: true },
  ...
  // Teacher
  {
    ...
    children: [
      ...
      { path: 'classes/:classId', name: 'teacher-class-detail', component: TeacherClassDetail, props: true },
      ...
      { path: 'results', name: 'teacher-results', component: TeacherResultInput },
      { path: 'classes/:classId/attendance', name: 'teacher-class-attendance', component: TeacherAttendance, props: true },
      { path: 'classes/:classId/results', name: 'teacher-class-results', component: TeacherResultInput, props: true },
  ...
  // Admin
  {
    ...
    children: [
      ...
      { path: 'enrollments', name: 'admin-enrollments', component: AdminEnrollments },
