...
public sealed record MockPaymentResponse(string PaymentUrl, string Provider, string ReferenceCode, DateTime ExpiresAt);
...
public sealed class CreateMockPaymentRequest
{
    [Required] public Guid InvoiceId { get; set; }
    [Range(0.01, double.MaxValue)] public decimal Amount { get; set; }
    public PaymentMethod Method { get; set; } = PaymentMethod.Vnpay;
    public string ReturnUrl { get; set; } = "https://educenter.local/payment-result";
}
