...
public static class CourseMappings
{
    ...
    public static ScheduleResponse ToResponse(this Schedule x) => new(x.Id, x.ClassId, x.ClassNameSnapshot, x.Class?.TeacherId, x.Class?.TeacherNameSnapshot, x.DayOfWeek, x.StudyShift, x.StartTime, x.EndTime, x.Room, x.Topic, x.SessionNumber, x.Status, x.CreatedAt, x.UpdatedAt);
