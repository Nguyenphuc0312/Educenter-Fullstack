...
namespace StudentAttendanceService.Repositories;

public sealed class EfRepository<TEntity>(StudentDbContext dbContext) : IRepository<TEntity> where TEntity : class
{
